...
$we=$result->fetch_object();
 ...
 $id=$_GET['edit'];
$sq="SELECT * FROM `employee` WHERE `e_id` ='$id'";
$res=$con->query($sq);
$r=$res->fetch_object();
?>
...
<div class="dashboard-container">
	...
	<input type="hidden" name="id" value="<?php echo $r->e_id ?>" >
						<!-- Headline -->
						<div class="headline">
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Job Title</h5>
										<input type="text" class="with-border" name="title" value="<?php echo $r->gig_title; ?>">
									</div>
								</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<select class="selectpicker with-border" data-size="7" title="Select Job Type" name="type">
											...
											<option value="PT" selected="selected">Part Time</option>
											<option value="IS">Internship</option>
											<option value="TP">Temporary</option>
										</select>
										<?php 
										...
										<select class="selectpicker with-border" data-size="7" title="Select Job Type" name="type">
											<option value="FT" >Full Time</option>
											<option value="PT" >Part Time</option>
											<option value="IS" selected="selected">Internship</option>
											<option value="TP">Temporary</option>
										</select>
										<?php 
                                         }
										...
										<select class="selectpicker with-border" data-size="7" title="Select Job Type" name="type">
											...
											<option value="PT">Part Time</option>
											<option value="IS">Internship</option>
											<option value="TP"  selected="selected">Temporary</option>
										</select>
										<?php 
                                         }
										?>
										...
										<select class="selectpicker with-border" data-size="7" title="Select Category" name="cate">
											...
											$res=$con->query($sql);
							                 while ($re=$res->fetch_object()) 
							                    {    	if ($r->cat_id ==$re->c_id ) {
							                    	 ?>
							                    	<option value="<?php echo $re->c_id  ?>" selected="selected"><?php echo($re->name); ?></option>
							                    <?php }
							                    else { ?>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="input-with-icon">
													<input class="with-border" type="text" placeholder="Limit" name="sal"  value="<?php echo ($r->price_hour); ?>">
									...
									<div class="submit-field">
										...
										<div class="keywords-container">
											<div class="keyword-input-container">
												<input type="text" class="keyword-input with-border" placeholder="e.g. job title, responsibilites" name="sear"  value="<?php echo ($r->search); ?>"/>
											</div>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										...
										<textarea cols="30" rows="5" class="with-border" name="description" value="<?php echo $r->description; ?>"></textarea>
				...
				<div class="col-xl-12">
					<button class="button ripple-effect big margin-top-30" name="editgig"> Save channges</button>
				</div>
			</form>
			</div>
			<!-- Row / End -->
