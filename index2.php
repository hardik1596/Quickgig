			...
			<div class="col-md-12">
				<div class="intro-banner-search-form margin-top-95">
					...
					<div class="intro-search-button">
						<button class="button ripple-effect" onclick="window.location.href='freelancers-grid-layout.php'">Search</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="listser.php?sid=<?php echo $we->c_id; ?>" class="photo-box small" data-background-image="images/job-category-01.jpg">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.html"><?php echo $we->fname." ".$we->lname; ?></a></h4>
